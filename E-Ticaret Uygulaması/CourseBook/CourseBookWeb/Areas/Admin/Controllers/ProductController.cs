    ...
    public class ProductController : Controller
    {
        ...
        public IActionResult Upsert(int? id)
        {
            ProductViewModels productVM = new()
            {
                ...
                CourseFormatTypeList = _unitOfWork.CourseFormatType.GetAll().Select(i => new SelectListItem
                {
                    Text = i.Name,
                    Value = i.Id.ToString()
                }),
        ...
        {
            var productList = _unitOfWork.Product.GetAll(includeProperties: "Category,CourseFormatType");
